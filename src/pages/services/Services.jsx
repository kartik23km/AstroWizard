  ...
  const services = [
    {
      ...
      description: "A comprehensive map of the sky at the exact moment of your birth. Discover your strengths, challenges, and life's primary purpose.",
      price: "$89",
      popular: true,
    },
    {
      ...
      description: "Understand the current planetary energies affecting your life. Perfect for planning major life transitions and career moves.",
      price: "$59",
      popular: false,
    },
    {
      ...
      description: "Compare two birth charts to understand the cosmic chemistry, communication styles, and karmic bonds between you and a partner.",
      price: "$119",
      popular: false,
    },
    {
      ...
      description: "Find clarity on immediate questions using a blend of traditional Rider-Waite symbolism and intuitive cosmic channeling.",
      price: "$45",
      popular: false,
    }
  ];
      ...
      <main className="grow max-w-6xl mx-auto px-6 py-16 flex flex-col justify-center">
        <div className="text-center space-y-6 max-w-3xl mx-auto mb-16">
          ...
          <p className="text-light-gray text-lg md:text-xl leading-relaxed">
            Choose from our specialized cosmic readings designed to bring clarity, validation, and astronomical insight into your daily life.
          </p>
        </div>
          ...
          {services.map((svc, i) => (
            <div 
              ...
              className={`bg-dark-surface border rounded-3xl p-8 hover:border-violet-glow transition-all duration-300 relative overflow-hidden group flex flex-col justify-between ${
                svc.popular ? "border-violet-glow/80 ring-2 ring-violet-glow/20" : "border-muted-gray/30"
              }`}
            >
              {svc.popular && (
              ...
              <div className="mt-8 flex justify-between items-center pt-6 border-t border-muted-gray/20">
                <div>
                  <span className="text-xs text-light-gray block">Energy Exchange</span>
                  <span className="text-2xl font-bold text-gold">{svc.price}</span>
                </div>
                <button className={`cursor-pointer px-5 py-2 rounded-xl text-sm font-semibold transition-all duration-300 ${
                  svc.popular 
