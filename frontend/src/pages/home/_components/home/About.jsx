...
const About = () => {
  ...
  <div className="flex flex-col justify-center px-8 py-12 md:px-14 md:py-16">
    ...
    <p className="text-light-gray/80 text-sm md:text-base leading-relaxed mb-5 font-light">
      ...
      is built to connect people with trusted Indian astrologers for genuine
      guidance rooted in Vedic astrology, numerology, kundli analysis, vastu,
      and spiritual wisdom.
    </p>

    <p className="text-light-gray/60 text-sm leading-relaxed font-light">
      From career and marriage to business, finance, health, and family life,
      our experienced astrologers provide practical solutions and spiritual
      clarity for modern-day challenges.
    </p>
